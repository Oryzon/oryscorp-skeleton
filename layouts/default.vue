            ...
            <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
                ...
                <div class="hidden lg:flex lg:gap-x-12">
                    <NuxtLink
                            ...
                            active-class="border-b-4 border-teal-500"
                    >{{ menu.name }}</NuxtLink>
                </div>
            </nav>
                    ...
                    <div class="mt-6 flow-root">
                        <div class="-my-6 divide-y divide-gray-500/10">
                            <div class="space-y-2 py-6">
                                <NuxtLink v-for="menu in headers" :to="menu.slug" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">{{ menu.name }}</NuxtLink>
                            </div>
                        </div>
                    </div>
                </div>
